...
subroutine ocean_model_data2D_get(OS,Ocean, name, array2D,isc,jsc)
  ...
  case('tlon')
      array2D(isc:iec,jsc:jec) = Grid%xt(Domain%isc:Domain%iec,Domain%jsc:Domain%jec)
  case('tlat')
      array2D(isc:iec,jsc:jec) = Grid%yt(Domain%isc:Domain%iec,Domain%jsc:Domain%jec)
  case('ulon')
      array2D(isc:iec,jsc:jec) = Grid%xu(Domain%isc:Domain%iec,Domain%jsc:Domain%jec)
  case('ulat')
      array2D(isc:iec,jsc:jec) = Grid%yu(Domain%isc:Domain%iec,Domain%jsc:Domain%jec)
  case('t_pme')
